...
![](https://img.shields.io/badge/Qt-6.10.1%2B-lightgreen)
...
若要从源代码构建，当前只支持在Windows上使用Visual Studio 2022进行编译。请确保安装了Qt 6.10.1及其开发工具，并且在Visual Studio中配置了Qt的路径。
...
## 对于每个Visual Studio项目
* resource - 存放要参与编译的资源，他们应该都被记录在qrc文件内。
