#ifndef Plugin_ASERStudio_AStorySyntax_AStoryXDocument_h
#define Plugin_ASERStudio_AStorySyntax_AStoryXDocument_h
...
#endif // Plugin_ASERStudio_AStorySyntax_AStoryXDocument_h
