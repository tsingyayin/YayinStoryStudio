...
namespace ASERStudio::AStorySyntax {
	...
	*/
	...
	/*!
	   ...
	   \value RuleNotSelected 没有选择任何规则
	   \value NoSuchRule 没有这样的规则
	   \value NoSuchController 没有这样的控制器
	   \value MissingRequiredParameter 缺少必选参数
	   \value ParameterTypeMismatch 参数类型不匹配
	   \value ParameterOutOfRange 参数值超出范围
	   \value ParameterFormatError 参数格式错误
	...
	*/
	...
	/*!
		...
		\since ASERStudio 2.0
		\a other 另一个AStoryXDiagnosticData实例
