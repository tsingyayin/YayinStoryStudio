#ifndef YayinStoryStudio_Editor_NewProjectPage_NewProjectWin_h
#define YayinStoryStudio_Editor_NewProjectPage_NewProjectWin_h
...
#endif // YayinStoryStudio_Editor_NewProjectPage_NewProjectWin_h
