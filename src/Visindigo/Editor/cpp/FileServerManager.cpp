...
namespace Visindigo::Editor {
	...
	/*!
		\class Visindigo::Editor::FileServerManager
		\inmodule Visindigo
	...
	*/
	...
	/*!
		\fn Visindigo::Editor::FileServerManager::builtinEditorCreated(Visindigo::Editor::FileEditWidget* editor)
		当内置编辑器被创建时发出该信号。

		这包括Visindigo::Editor::FileServer::EditorType为CodeEditor和BuiltInEditor的情况。
	*/

	/*!
		\fn Visindigo::Editor::FileServerManager::windowEditorCreated(QWidget* editor)
		当窗口编辑器被创建时发出该信号。
		这只对应Visindigo::Editor::FileServer::EditorType为WindowEditor的情况。
	*/
