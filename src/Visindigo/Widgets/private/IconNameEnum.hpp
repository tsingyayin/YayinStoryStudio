/*
	Warning: This File COULD ONLY be included by Widgets/IconFontRouter.h
*/
enum IconName : quint32 {
    ...
    Robot = 0xE99A,
    TapAndSend = 0xE9A1,
    TextBulletListSquareSparkle = 0xE9A3,
    ...
    Broom = 0xEA99,
    SignalBarsAni1 = 0xEAA1,
    SignalBarsAni2 = 0xEAA2,
    SignalBarsAni3 = 0xEAA3,
    EthernetAni1 = 0xEAA4,
    WifiAni1 = 0xEAA5,
    WifiAni2 = 0xEAA8,
    EmojiEdit = 0xEAAA,
    SurfaceTypecover = 0xEAAE,
    ChatSparkle = 0xEAB7,
    CellFlowVertical = 0xEABB,
    WindowsStudioEffects = 0xEABC,
    PortraitBlur = 0xEABE,
    ForwardCall = 0xEAC2,
    ...
    LiveCaptionsSparkle = 0xEAD8,
    Trackers = 0xEADF,
    Market = 0xEAFC,
    PieSingle = 0xEB05,
    StockUp = 0xEB0F,
    StockDown = 0xEB11,
    MobBatteryUnknownCharging = 0xEB17,
    ClicktoDoOff = 0xEB19,
    BatteryUnknownCharging = 0xEB1A,
    ClicktoDo = 0xEB1D,
    Glasses2 = 0xEB25,
    StatusSquareOuter = 0xEB33,
    StatusSquarePause = 0xEB34,
    GenericApp = 0xEB3B,
    Design = 0xEB3C,
    Website = 0xEB41,
    Drop = 0xEB42,
    ...
    VolumeBars = 0xEBC5,
    Project = 0xEBC6,
    SystemInPrivate = 0xEBC8,
    SystemInPrivateFilled = 0xEBC9,
    ...
    WidgetAdd = 0xF036,
    PasteSparkle = 0xF03D,
    AdvancedPaste = 0xF03E,
    PortraitLight = 0xF06C,
    DefaultAPN = 0xF080,
    UserAPN = 0xF081,
    DoublePinyin = 0xF085,
    BlueLight = 0xF08C,
    ...
    LassoSparkle = 0xF1B9,
    SquareSparkle = 0xF1BA,
    TextCursor2 = 0xF1BB,
    Lasso = 0xF1BE,
    ChromeSwitch = 0xF1CB,
    ChromeSwitchContast = 0xF1CC,
    TranslateSparkle = 0xF1D4,
    RefineSparkle = 0xF1D5,
    ReformatSparkle = 0xF1D6,
    StatusCheckmark = 0xF1D8,
    StatusCheckmarkLeft = 0xF1D9,
    LeafTwo = 0xF1E8,
    GridviewGroup = 0xF207,
