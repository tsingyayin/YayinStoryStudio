...
namespace Visindigo::General {
	...
	*/
	...
	/*!
		...
		析构TranslationHost对象。
		一般来说，没有任何情况需要手动析构此对象。TranslationHost应该与使用它的应用程序有一致的生命周期。
	*/
	...
	*/
	...
	/*!
		\fn Visindigo::General::TranslationHost::tra(const QString& nameSpace, const QString& key)
		\since Visindigo 0.13.0
	...
	*/
	...
	/*!
		\fn Visindigo::General::TranslationHost::tra(const QString& key)
		\since Visindigo 0.13.0
