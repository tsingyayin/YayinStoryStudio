...
namespace Visindigo::Utility {
	...
	public:
		...
		static QString toLegalFileName(const QString& name, const QString& replace = "_");
		...
		static QDateTime getFileCreateTime(const QString& filePath);
		...
		static QString moveToTrash(const QString& path);
		...
		static bool isPathInDir(const QString& path, const QString& dir);
