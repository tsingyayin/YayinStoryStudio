...
* and wrapped in Visindigo::__Private__ namespace to avoid potential conflicts.
* This file is used to create meta data for Qt::Key enum values, which is not
* provided by Qt itself. Actually I don know why.
*/
namespace Visindigo::__Private__ {
    class QtNamespaceKey :public QObject{
        Q_OBJECT;
    public:
        // from Qt 6.8.3 MSVC2022_x64
        enum KeyEnum {
